...
var Toolbar = function (_a) {
    ...
    var _b;
    return (react_1.default.createElement(Toolbar_1.default, __assign({ className: classnames_1.default(classes.toolbar, (_b = {},
            _b[classes.mobileToolbar] = width === 'xs',
            _b[classes.desktopToolbar] = width !== 'xs',
            _b), className) }, rest), react_1.Children.count(children) === 0 ? (react_1.default.createElement("div", { className: classes.defaultToolbar },
